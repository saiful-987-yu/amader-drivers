...
(function (window, Utils) {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "doctor.rateSectionTitle": "Rate This Doctor",
      ...
      "driver.vehiclePhotos": "Vehicle Photos",
      "driver.ratingSectionTitle": "Rate This Driver",
      "driver.ratingCommentPlaceholder": "Write a comment (optional)",
      "driver.ratingSubmit": "Submit",
      "driver.ratingUnavailable": "Rating submission is currently unavailable.",
      ...
      "driver.callAlternative": "Call Alternative",
      "driver.whatsapp": "WhatsApp",
      "driver.ratingAria": "{n} out of 5 stars",
      "driver.reviewsEmpty": "No reviews yet.",
      "driver.viewAllReviews": "View All Reviews",
      "driver.closeReviews": "Close Reviews",
      "driver.reviewCount": "({n} reviews)",
      "driver.ratingSubmitted": "Thank you! Your review has been submitted for approval.",
      "driver.ratingSelectStars": "Please select a star rating.",
      "detail.personalDetails": "Personal Details",
      "detail.video": "Video",
      ...
      "register.step3.instructions": "Enter your Google Drive photo link (sharing must be set to \"Anyone with the link\"). If that's not possible,",
      ...
      "register.step3.photoUpload.title": "Upload Photo Here",
      "register.step3.photoUpload.subtitle": "Tap to open the Google Form and upload your Profile and Vehicle Photo",
      "register.step3.photoUpload.reopenForm": "Reopen the form",
      "register.step3.photoUpload.confirmButton": "I've submitted it on the Google Form",
      "register.step3.photoUpload.confirmedTitle": "Photo submitted ✓",
      "register.step3.photoUpload.confirmedSubtitle": "Submitted via Google Form",
      "register.step3.photoUpload.undo": "Not done yet? Tap to redo",
      ...
      "validation.pinWrong": "PIN Incorrect",
      "validation.pinCorrect": "PIN Correct",
      ...
      "profile.verifiedBadge": "Verified Driver",
      "profile.ratingLabel": "{rating} (out of 5)",
      "profile.accountStatus": "Account Status",
      "profile.availability": "Availability",
      "profile.adminStatus": "Admin Status",
      "profile.setActive": "Active",
      "profile.setInactive": "Inactive",
      "profile.availableDesc": "You can receive calls and work",
      "profile.unavailableDesc": "You won't receive calls",
      ...
      "profile.whatsappActive": "Active",
      "profile.whatsappInactive": "Not Available",

      "profile.serviceAreas": "Service Areas",
      "profile.vehicleInformation": "Vehicle Information",
      "profile.preferredBazar": "Preferred Bazar",

      "profile.profileFields": "Profile Fields",
      "profile.bengaliName": "Bengali Name",
      "profile.guardianName": "Father/Husband Name",
      "profile.email": "Email",
      "profile.editProfile": "Edit Profile",
      "profile.save": "Save",
      "profile.saving": "Saving…",
      "profile.editSuccess": "Your profile has been updated.",
      "profile.editError": "We couldn't update your profile. Please try again.",
      "profile.noChanges": "Change at least one field to save.",
      ...
      "profile.oldPasswordWrong": "Old password is incorrect.",
    ...
    bn: {
      ...
      "driver.vehiclePhotos": "যানবাহনের ছবি",
      "driver.ratingSectionTitle": "এই ড্রাইভারকে রেট করুন",
      "driver.ratingCommentPlaceholder": "মন্তব্য লিখুন (ঐচ্ছিক)",
      "driver.ratingSubmit": "জমা দিন",
      "driver.ratingUnavailable": "রেটিং জমা দেওয়ার সুবিধাটি এখন উপলব্ধ নয়।",
      "a11y.previousImage": "আগের ছবি",
      "a11y.nextImage": "পরের ছবি",
      ...
      "driver.callAlternative": "বিকল্প নম্বরে কল করুন",
      "driver.whatsapp": "হোয়াটসঅ্যাপ",
      "driver.ratingAria": "৫ এর মধ্যে {n} তারকা",
      "driver.reviewsEmpty": "এখনো কোনো রিভিউ নেই।",
      "driver.viewAllReviews": "সব রিভিউ দেখুন",
      "driver.closeReviews": "রিভিউ বন্ধ করুন",
      "driver.reviewCount": "({n}টি রিভিউ)",
      "driver.ratingSubmitted": "ধন্যবাদ! আপনার রিভিউ অনুমোদনের জন্য জমা দেওয়া হয়েছে।",
      "driver.ratingSelectStars": "অনুগ্রহ করে একটি স্টার রেটিং নির্বাচন করুন।",
      "detail.personalDetails": "ব্যক্তিগত তথ্য",
      "detail.video": "ভিডিও",
      ...
      "register.step3.instructions": "আপনার Google Drive ছবির Link দিন (Access অবশ্যই \"Anyone with the link\" করা থাকতে হবে। এটি না পারলে।",
      ...
      "register.step3.photoUpload.title": "এখানে ছবি আপলোড করুন",
      "register.step3.photoUpload.subtitle": "Google Form-এ গিয়ে আপনার প্রোফাইল ও যানবাহনের ছবি আপডেট করুন।",
      "register.step3.photoUpload.reopenForm": "ফর্মটি আবার খুলুন",
      "register.step3.photoUpload.confirmButton": "আমি Google Form-এ Submit করেছি",
      "register.step3.photoUpload.confirmedTitle": "ছবি জমা দেওয়া হয়েছে ✓",
      "register.step3.photoUpload.confirmedSubtitle": "Google Form-এর মাধ্যমে জমা দেওয়া হয়েছে",
      "register.step3.photoUpload.undo": "এখনো Submit করেননি? আবার করতে চাপ দিন",
      ...
      "validation.pinWrong": "PIN ভুল",
      "validation.pinCorrect": "PIN সঠিক",
      ...
      "profile.verifiedBadge": "যাচাইকৃত ড্রাইভার",
      "profile.ratingLabel": "{rating} (৫ এর মধ্যে)",
      "profile.accountStatus": "অ্যাকাউন্ট স্ট্যাটাস",
      "profile.availability": "উপলব্ধতা",
      "profile.adminStatus": "অ্যাডমিন স্ট্যাটাস",
      "profile.setActive": "সক্রিয়",
      "profile.setInactive": "নিষ্ক্রিয়",
      "profile.availableDesc": "আপনি কল ও কাজ গ্রহণ করতে পারবেন",
      "profile.unavailableDesc": "আপনি কল পাবেন না",
      ...
      "profile.logoutConfirm": "আপনি কি লগআউট করতে নিশ্চিত?",

      "profile.accountOverview": "অ্যাকাউন্ট ওভারভিউ",
      "profile.driverId": "ড্রাইভার আইডি",
      "profile.primaryPhone": "প্রধান ফোন নম্বর",
      "profile.whatsappActive": "সক্রিয়",
      "profile.whatsappInactive": "উপলব্ধ নয়",

      "profile.serviceAreas": "সার্ভিস এলাকা",
      "profile.vehicleInformation": "যানবাহনের তথ্য",
      "profile.preferredBazar": "পছন্দের বাজার",

      "profile.profileFields": "প্রোফাইল তথ্য",
      "profile.bengaliName": "বাংলা নাম",
      "profile.guardianName": "পিতা/স্বামীর নাম",
      "profile.email": "ইমেইল",
      "profile.editProfile": "প্রোফাইল সম্পাদনা করুন",
      "profile.save": "সংরক্ষণ করুন",
      "profile.saving": "সংরক্ষণ হচ্ছে…",
      "profile.editSuccess": "আপনার প্রোফাইল হালনাগাদ করা হয়েছে।",
      "profile.editError": "আপনার প্রোফাইল হালনাগাদ করা যায়নি। আবার চেষ্টা করুন।",
      "profile.noChanges": "সংরক্ষণ করতে অন্তত একটি তথ্য পরিবর্তন করুন।",

      "profile.changePassword": "পাসওয়ার্ড পরিবর্তন করুন",
      "profile.changePasswordSub": "আপনার অ্যাকাউন্টের পাসওয়ার্ড হালনাগাদ করুন",
      "profile.oldPassword": "পুরনো পাসওয়ার্ড",
      "profile.newPassword": "নতুন পাসওয়ার্ড",
      "profile.confirmNewPassword": "নতুন পাসওয়ার্ড নিশ্চিত করুন",
      "profile.passwordUpdated": "আপনার পাসওয়ার্ড হালনাগাদ করা হয়েছে।",
      "profile.oldPasswordWrong": "পুরনো পাসওয়ার্ড সঠিক নয়।",

      "profile.vehiclePhotosSub": "আপনার যানবাহনের ছবি দেখুন",
      "profile.noPhotos": "কোনো ছবি নেই",
